...
namespace tars
{
    ...
    public:
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(nodeName, false);
            return _os;
        }
    public:
        std::string host;
    ...
    {
        return l.host == r.host && l.port == r.port && l.timeout == r.timeout && l.istcp == r.istcp && l.grid == r.grid && l.groupworkid == r.groupworkid && l.grouprealid == r.grouprealid && l.setId == r.setId && l.qos == r.qos && l.bakFlag == r.bakFlag && l.weight == r.weight && l.weightType == r.weightType && l.authType == r.authType && l.nodeName == r.nodeName;
    }
    inline bool operator!=(const EndpointF&l, const EndpointF&r)
    {
        return !(l == r);
    ...
    public:
        ...
        void writeTo(tars::TarsOutputStream<WriterT>& _os) const
        {
            if (!vActiveEndpoints.empty())
            {
                _os.write(vActiveEndpoints, 0);
            }
            if (!vInactiveEndpoints.empty())
            {
        ...
        {
            resetDefautlt();
            _is.read(vActiveEndpoints, 0, false);
            _is.read(vInactiveEndpoints, 1, false);
        }
        tars::JsonValueObjPtr writeToJson() const
        {
            tars::JsonValueObjPtr p = new tars::JsonValueObj();
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonValueObjPtr pObj=tars::JsonValueObjPtr::dynamicCast(p);
            tars::JsonInput::readJson(vActiveEndpoints,pObj->value["vActiveEndpoints"], false);
            tars::JsonInput::readJson(vInactiveEndpoints,pObj->value["vInactiveEndpoints"], false);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
