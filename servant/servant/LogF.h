            ...
            switch(r.first - __Log_all)
            {
                case 0:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "logger", 0, _trace_param_, "");
                    }
                ...
                case 1:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "loggerbyInfo", 0, _trace_param_, "");
                    }
    ...
    public:
        ...
        void logger(const std::string & app,const std::string & server,const std::string & file,const std::string & format,const vector<std::string> & buffer,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                if (ServantProxyThreadData::TraceContext::ENP_NORMAL == _trace_param_flag_)
                {
                    ...
                    _p_->value["file"] = tars::JsonOutput::writeJson(file);
                    _p_->value["format"] = tars::JsonOutput::writeJson(format);
                    _p_->value["buffer"] = tars::JsonOutput::writeJson(buffer);
                    _trace_param_ = tars::TC_Json::writeValue(_p_);
                }
                else if(ServantProxyThreadData::TraceContext::ENP_OVERMAXLEN == _trace_param_flag_)
                {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "logger", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "logger", 0, _trace_param_, "");
            }
        ...
        void loggerbyInfo(const tars::LogInfo & info,const vector<std::string> & buffer,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "loggerbyInfo", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "loggerbyInfo", 0, _trace_param_, "");
            }
    ...
    public:
        ...
        static void async_response_logger(tars::TarsCurrentPtr _current_)
        {
            ...
            if (_current_->isTraced())
            {
                ...
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "logger", 0, _trace_param_, "");
                }
            }
        ...
        static void async_response_loggerbyInfo(tars::TarsCurrentPtr _current_)
        {
            ...
            if (_current_->isTraced())
            {
                ...
                if(_current_->getServantHandle())
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "loggerbyInfo", 0, _trace_param_, "");
                }
            }
            ...
            switch(r.first - __tars__Log_all)
            {
                case 0:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "logger", 0, _trace_param_, "");
                    }
                    ...
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "logger", 0, _trace_param_, "");
                        }
                ...
                case 1:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "loggerbyInfo", 0, _trace_param_, "");
                    }
                    ...
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "loggerbyInfo", 0, _trace_param_, "");
                        }
