            ...
            switch(r.first - __Auth_all)
            {
                case 0:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "applyToken", 0, _trace_param_, "");
                    }
                ...
                case 1:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "authProcess", 0, _trace_param_, "");
                    }
                ...
                case 2:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "deleteToken", 0, _trace_param_, "");
                    }
                ...
                case 3:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "getTokens", 0, _trace_param_, "");
                    }
    ...
    public:
        ...
        tars::ApplyTokenResponse applyToken(const tars::ApplyTokenRequest & request,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "applyToken", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "applyToken", 0, _trace_param_, "");
            }
        ...
        tars::Int32 authProcess(const tars::AuthRequest & request,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "authProcess", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "authProcess", 0, _trace_param_, "");
            }
        ...
        tars::Int32 deleteToken(const tars::DeleteTokenRequest & request,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "deleteToken", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "deleteToken", 0, _trace_param_, "");
            }
        ...
        vector<tars::TokenResponse> getTokens(const tars::TokenRequest & request,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "getTokens", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "getTokens", 0, _trace_param_, "");
            }
    ...
    public:
        ...
        static void async_response_applyToken(tars::TarsCurrentPtr _current_, const tars::ApplyTokenResponse &_ret)
        {
            ...
            if (_current_->isTraced())
            {
                ...
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "applyToken", 0, _trace_param_, "");
                }
            }
        ...
        static void async_response_authProcess(tars::TarsCurrentPtr _current_, tars::Int32 _ret)
        {
            ...
            if (_current_->isTraced())
            {
                ...
                if(_current_->getServantHandle())
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "authProcess", 0, _trace_param_, "");
                }
            }
        ...
        static void async_response_deleteToken(tars::TarsCurrentPtr _current_, tars::Int32 _ret)
        {
            ...
            if (_current_->isTraced())
            {
                ...
                if(_current_->getServantHandle())
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "deleteToken", 0, _trace_param_, "");
                }
            }
        ...
        static void async_response_getTokens(tars::TarsCurrentPtr _current_, const vector<tars::TokenResponse> &_ret)
        {
            ...
            if (_current_->isTraced())
            {
                ...
                if(_current_->getServantHandle())
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "getTokens", 0, _trace_param_, "");
                }
            }
            ...
            switch(r.first - __tars__Auth_all)
            {
                case 0:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "applyToken", 0, _trace_param_, "");
                    }
                    ...
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "applyToken", 0, _trace_param_, "");
                        }
                ...
                case 1:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "authProcess", 0, _trace_param_, "");
                    }
                    ...
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "authProcess", 0, _trace_param_, "");
                        }
                ...
                case 2:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "deleteToken", 0, _trace_param_, "");
                    }
                    ...
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "deleteToken", 0, _trace_param_, "");
                        }
                ...
                case 3:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "getTokens", 0, _trace_param_, "");
                    }
                    ...
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "getTokens", 0, _trace_param_, "");
                        }
